---
title: "State of the Union: Text & Sentiment Analysis"
author: "Lucas Boyd"
date: "3/3/2022"
output: 
  html_document:
...
**Setup:**
Attaching required packages and reading in text data. 
...
speech_cloud_biden <- ggplot(data = top_50_words_biden, aes(label = word)) + # labeling the words with their values
  ...
  scale_size_area(max_size = 6.5) + # limiting the size of the biggest words
...
biden_bar <- ggplot(data = top_20_climate_biden, aes(x = reorder(word, n), y = n, fill = n)) + # make the plot in descending order
  ...
  labs(y = element_blank(),
       x = element_blank()) +
  geom_rect(ymin = 2.1, ymax = 6.3, xmin = 0, xmax = 1.4, fill = "darkgreen") # allowing "climate" to be seen
...
trump_bar <- ggplot(data = top_20_climate_trump, aes(x = reorder(word, n), y = n, fill = n)) +
  ...
  geom_rect(ymin = 2.7, ymax = 6.8, xmin = 0, xmax = 1.4, fill = "darkgreen")
...
# interactive datatables for searching speci
datatable(dt_biden, colnames = c("Word", "Count"),
          class = 'cell-border stripe',
          caption = "Biden 2022")
datatable(dt_trump, colnames = c("Word", "Count"),
          class = 'cell-border stripe',
          caption = "Trump 2020"
          )
```
